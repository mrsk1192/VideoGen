...
def runtime_diagnostics(
    *,
    ...
    output: Dict[str, Any] = {
        ...
        "prefer_safetensors": parse_bool_setting(server_settings.get("prefer_safetensors", True), default=True),
        "force_bin_weights": parse_bool_setting(server_settings.get("force_bin_weights", False), default=False),
        "verify_safetensors_on_load": parse_bool_setting(server_settings.get("verify_safetensors_on_load", True), default=True),
